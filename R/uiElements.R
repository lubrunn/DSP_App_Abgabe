...
tabs_custom_gra <- function(){
  tabsetPanel(
    ...
    tabPanel("Model specifcation",
             ...
             radioButtons("Granger_outcome","Which variable?",c("Adj.Close","Return","log_Close"),selected = "Return"),
...
tabs_custom <- function(){
  tabsetPanel(
    ...
    tabPanel("Model specifcation",
             ...
             radioButtons("regression_outcome","Which variable?",c("Adj.Close","Return","log_Close"),selected = "Return"),
...
tabs_custom_var <- function(){
  tabsetPanel(
    ...
    tabPanel("Model specifcation",
             ...
             radioButtons("regression_outcome_var","Which variable?",c("Adj.Close","Return","log_Close"),selected = "Return"),
...
tabs_custom_xgb <- function(){
  tabsetPanel(
    ...
    tabPanel("Model specifcation",
             ...
             radioButtons("regression_outcome_xgb","Which variable?",c("Adj.Close","Return","log_Close"),selected = "Return",inline = T),
