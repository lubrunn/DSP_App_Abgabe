...
tabs_custom_gra <- function(){
  tabsetPanel(
    ...
    tabPanel("Model specifcation",
             ...
             radioButtons("Granger_outcome","variable:",choices=c("Adjusted Close"="Adj.Close","Return"="Return","log Adj. Close"="log_Close")),
             tags$hr(),
...
tabs_custom <- function(){
  tabsetPanel(
    ...
    tabPanel("Model specifcation",
             ...
             radioButtons("regression_outcome","variable:",c("Adjusted Close"="Adj.Close","Return"="Return","log Adj. Close"="log_Close")),
             tags$hr(),
...
tabs_custom_var <- function(){
  tabsetPanel(
    ...
    tabPanel("Model specifcation",
             ...
             radioButtons("regression_outcome_var","variable:",c("Adjusted Close"="Adj.Close","Return"="Return","log Adj. Close"="log_Close")),
             tags$hr(),
             tags$h4("Choose control variables:"),
